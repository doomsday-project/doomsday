...
<body>
	...
	<script>
      ...
      return [40, 167, 69];
				...
				statusCode: {
					200: function(data) {
						...
						for (var i = 0; i < data.content.length; i++) {
							...
							if (!shouldShowMoreCerts && cert.not_after - now > 7776000) {
								break;
							}
						...
						$("#certs").show();
						if (certUpdateID == NO_CERT_UDPATE_ID) {
		...
		NO_CERT_UPDATE_ID = -1;
		certUpdateID = NO_CERT_UPDATE_ID;
...
`, MIMEType: `application/javascript` },
	"/web/assets/jquery-3.4.0.min.js": { Content: `/*! jQuery v3.4.0 | (c) JS Foundation and other contributors | jquery.org/license */
